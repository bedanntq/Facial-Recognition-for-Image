# USAGE
# python src/encode_face/encode_face.py --data data --encodings encodings.pickle
...
ap.add_argument("-i", "--data", required=True, help="path to the directory of faces and images")
